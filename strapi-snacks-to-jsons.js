...
const jsonUrlMap = [{
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=functional-programming",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=javascript-design-patterns",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=js-unit-testing",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=typescript",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=web-performance",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=web-components",
    },
    {
    ...
    },
    {
        ...
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=react-native",
    },
    {
    ...
    {
        filename: "js-clean-code.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=js-clean-code",
    },
    {
        filename: "js-clean-code.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=js-clean-code",
    },
    {
        filename: "git.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=git",
    },
    {
        filename: "git.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=git",
    },
    {
        filename: "frontend-challenges.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=frontend-challenges",
    },
    {
        filename: "frontend-challenges.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=frontend-challenges",
    },
    {
        filename: "cypress.snacks.json",
    ...
    {
        filename: "web-standards.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=web-standards",
    },
    {
        filename: "web-standards.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=web-standards",
    },
    {
        filename: "stenciljs.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=stenciljs",
    },
    {
        filename: "stenciljs.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=stenciljs",
    },
    {
        filename: "litelement.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=litelement",
    },
    {
        filename: "litelement.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=litelement",
    },
    {
        filename: "single-spa.snacks.json",
        urlPath: "/codersnacks-asoc-snack-categories?codersnacks_category.key=single-spa",
    },
    {
        filename: "single-spa.quizzes.json",
        urlPath: "/codersnacks-asoc-snack-quizs?codersnacks_category.key=single-spa",
    },
];
...
Promise.all(
    ...
    data.forEach(function(item) {
      ...
      // Persist count of snacks per category
      if (item.filename.indexOf('.snacks.') !== -1) {
        var countFilename = 'assets/jsons/' + item.filename;
        countFilename = countFilename.replace(
          'snacks.json',
          'snacks-count.json'
